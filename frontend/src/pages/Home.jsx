      ...
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="flex flex-col items-center space-y-4">
          ...
          <img
            ...
            className="h-24 animate-pulse transform transition duration-700 ease-in-out hover:scale-110"
          />
          {/* Texte animé */}
          <h1 className="text-black text-xl font-bold animate-fadeIn">
            Canal Vision+
          </h1>
        </div>
      </div>
    ...
    <div className="bg-white min-h-screen text-gray-900">
      ...
      <section className="py-16 px-8 grid md:grid-cols-3 gap-8 text-center">
        ...
        <div className="bg-gray-100 shadow-md p-6 rounded">
          ...
          <p className="text-gray-600">Un accompagnement dédié pour chaque partenaire.</p>
        </div>
      </section>

      {/* Footer */}
      <footer className="bg-black text-white text-center py-6">
        <p>© 2026 Vision Canal Plus. Tous droits réservés.</p>
